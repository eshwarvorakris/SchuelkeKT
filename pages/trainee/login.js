...
function Login() {
    ...
    const onSubmit=(data)=>{
        ...
        auth.login(data).then((res)=>{
            ...
            Cookies.set('loggedInUser', res.data.user, { expires: 1 / 1440 });
    ...
    <div>
      <div className="section-form">
        <div className="section-picture">
          <div className="floting-element-login">
            <img src="/trainee-images/Schuelke_Logo 5.png" className="big-logo-login"  style={{marginLeft:'350px'}} alt="" />
          </div>
          ...
          <div className="brand-info"style={{marginTop: '-219px'}}>
            <img className="brand-header-logo" src="/trainee-images/Schuelke_Logo 1 (1).png" alt=""  />
            <span>Knowledge Transfer</span>
            <p>Acquire and Apply to Achieve</p>

            <img src="/trainee-images/rafiki.png" className="traineeLogin-2-illustration" alt="" style={{height:'237.1650695800781px'}}/>
            ...
            <div className="social-logos d-flex">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16">
        ...
        <div className="section-login">
          ...
          <form className="form d-flex flex-column"  onSubmit={handleSubmit(onSubmit)}>
            ...
            {errorMessage &&
                <p className='text-danger p-2'>{errorMessage}</p>
            }
            <div className="form-group">
              <h1 style={{fontFamily: `Co-bold-2`}}>Your Journey starts here</h1>
              <label htmlFor="exampleInputEmail1" style={{fontFamily: `Co-bold-2`}}><b>Email</b></label>
              <input type="email" className="form-control mt-1"  {...register("email")} aria-describedby="emailHelp"
                placeholder="thomas@schulke.com"  />
            </div>
            <div className="form-group">
              <label htmlFor="exampleInputPassword1" style={{fontFamily: `Co-light-2`}}><b>Password</b></label>
              <input type="password" className="form-control mt-1"  {...register("password")} placeholder="Enter Your Password"
                 />
            </div>
