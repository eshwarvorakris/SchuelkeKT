...
function Login() {
    ...
    const onSubmit=(data)=>{
        ...
        auth.login(data).then((res)=>{
            ...
            Cookies.set('loggedInUser', res.data.user, { expires: 1 / 24 });
            Cookies.set('first_name', res.data.user.first_name, { expires: 1 / 24 });
        ...
        <div className="section-login">
          ...
          <form className="form d-flex flex-column"  onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group">
              ...
              <label for="exampleInputEmail1" style={{fontFamily: `Co-bold-2`}}><b>Email</b></label>
              <input type="email" className="form-control mt-1"  {...register("email")} aria-describedby="emailHelp"
                placeholder="thomas@schulke.com"  />
            </div>
            <div className="form-group">
              <label for="exampleInputPassword1" style={{fontFamily: `Co-light-2`}}><b>Password</b></label>
