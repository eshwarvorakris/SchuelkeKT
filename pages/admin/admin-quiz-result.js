            ...
            <div class="section1-edit">
                ...
                <div class="container-2">
                    <div class="col-md-12 trainee-right">
                        ...
                        <Topnavbar/>
                        <div class="trainee-right-body">
                            <div class="trainee-profile-pic">
                                <div class="box-1"></div>
                                <div class="box-2"></div>
                                <div class="box-3 text-tag">
                                    <h6>My Info</h6>
                                </div>
                                <img class="profile-picture" src="/images/trainee-images/trainer.jpg" alt="" />
                            </div>
                            ...
                            <div class="edit-profile-btn">
                                ...
                                <a href="admin-Profile-edit.html">
                                    <button type="button" class="btn edit-btn text-light" style="background-color: #008bd6">
                                        Edit Profile 🖋
                                    </button>
                                </a>
                            </div>
