...
exports.login = async function (req, res) {
  ...
  await User.findOne({
    attributes: [
      'id', 'full_name', 'email', 'country', 'profile_img', 'contact_no', 'dob', 'address', 'edu_background', 'role', 'password', 'user_id'],
    ...
    if (result !== null) {
      ...
      var access_token = auth.generateToken(_.pick(result?.dataValues, ['role', 'id', 'country', 'full_name', 'user_id', 'email']));
